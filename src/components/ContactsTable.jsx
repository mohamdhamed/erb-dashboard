                    ...
                    <div key={item.id} className="bg-white p-4 rounded-lg shadow-sm border border-gray-200">
                        <div className="flex justify-between items-start mb-2">
                            ...
                            <div className="text-right">
                                <span className="block text-xs text-gray-500">مستحق</span>
                        ...
                        <div className="grid grid-cols-2 gap-2 text-sm text-gray-600 border-t pt-2 mt-2 bg-gray-50 p-2 rounded">
